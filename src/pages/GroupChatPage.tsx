  ...
  return (
    <PhoneFrame tone="light">
      ...
      <div className="mt-4 flex items-center gap-3 text-black">
          ...
          <h1 className="text-xl sm:text-3xl">Nhóm FlareUp</h1>
        </div>
        ...
        <section className="mt-6 text-center text-black">
          ...
          <h2 className="mt-4 text-lg sm:text-3xl">Hãy bắt đầu trò chuyện!</h2>

          <div className="mt-8 border-y-2 border-[#b64047] py-4 text-left">
            <div className="mb-3 w-fit rounded-[45px] bg-[#f1a7a3] px-4 py-2 text-xs sm:text-sm text-white">
              Chào mọi người!
            </div>
            <div className="w-fit rounded-[45px] bg-[#f1a7a3] px-4 py-2 text-xs sm:text-sm text-white">
              Rất vui được làm việc chung với mọi người
            </div>
          </div>

          <div className="mt-4 rounded-[24px] bg-[#f0f1f2] px-4 py-3 text-left text-xs sm:text-sm text-[#7d7f85]">
            Gửi tin nhắn....
          </div>
        </section>
