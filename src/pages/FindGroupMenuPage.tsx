  ...
  return (
    <PhoneFrame tone="teal">
      ...
      <div className="mt-12 space-y-8 px-1">
        ...
        <button className="w-full rounded-3xl border-2 border-black bg-[#ffe4e1] transition hover:scale-105 py-6 text-xl sm:text-xl text-[#555] shadow-[10px_16px_24px_rgba(0,0,0,0.35)]">
          Lập nhóm mới
        </button>
      </div>
